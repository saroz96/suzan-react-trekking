  ...
  if (error) {
    return (
      <div style={errorContainerStyle}>
        ...
        <button onClick={fetchTopSellerPackages} style={retryButtonStyle}>
          Try Again
        </button>
      </div>
    );
    ...
    <div style={sectionContainerStyle}>
      ...
      <div style={headerStyle}>
        <div style={titleContainerStyle}>
          <span style={exclusiveTagStyle}>Popular & Recommended!</span>
          <h2 style={mainTitleStyle}>ART's Top Sellers for 2026</h2>
        </div>
        <Link to="/top-seller-treks" style={viewAllButtonStyle}>
              ...
              <div style={cardStyle}>
                ...
                <div style={imageContainerStyle}>
                  ...
                  <div style={badgesContainerStyle}>
                    <span style={topSellerBadgeStyle}>Top Seller</span>
                    {pkg.isBestSeller && (
...
// Cards Grid - Same as BestSellersSection (4 columns)
...
// Card Styles - Same as BestSellersSection
const cardStyle = {
