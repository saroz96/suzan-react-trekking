...
const AllBestSellersPage: React.FC = () => {
  ...
  //       );
  //       setPackages(bestSellers);
  //       setFilteredPackages(bestSellers);
  ...
  //         packageName: string;
  //       }[] = [];
  //       bestSellers.forEach((pkg: TrekPackage) => {
  ...
  //         const durations = bestSellers.map((p: any) => p.durationDays || 0);
    ...
    return (
      <div style={styles.container}>
        <div style={styles.loadingContainer}>
          ...
          <p>Loading best seller packages...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div style={styles.container}>
          ...
          <>
            ...
            <div style={styles.heroOverlay}>
              <div style={styles.heroContent}>
                <h1 style={styles.heroTitle}>Best Selling Trips</h1>
                <p style={styles.heroSubtitle}>
                  Our most popular treks, loved by thousands of adventurers
                </p>
                <div style={styles.statsBadge}>
                  <span style={styles.statsIcon}>🏔️</span>
                  <span style={styles.statsText}>
                    {filteredPackages.length} Best Seller Package
      ...
      <div style={styles.breadcrumb}>
        ...
        <span style={styles.breadcrumbCurrent}>Best Selling Trips</span>
      </div>
          ...
          <div style={styles.packagesContainer}>
            <div style={styles.resultsSummary}>
              <p style={styles.resultsText}>
                ...
                <strong>{packages.length}</strong> best seller packages
              </p>
            </div>
...
export default AllBestSellersPage;
